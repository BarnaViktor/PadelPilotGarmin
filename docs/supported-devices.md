...
A jelenlegi fejlesztési és szimulátoros célkészülék:

- Garmin Forerunner 265 (`fr265`).

Ennek oka, hogy a felületet 416 × 416 pixeles, kerek AMOLED-kijelzőre és az
ötgombos UP/DOWN/START/BACK vezérlésre terveztük. A Forerunner 265 az egyetlen
olyan modell, amelyen valós órás elfogadási tesztet is végzünk. Ez nem
jelent kiadási vagy Store-támogatási ígéretet. Az új dizájn lezárása után a
megjelenítési kompatibilitást minden jelöltnél újra kell ellenőrizni.
...
|---|---|---:|---:|---|
| `fr265` | Forerunner 265 | 5.2 | igen | fejlesztési cél |
